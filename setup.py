...
setup(
    ...
    install_requires=[
        "git+https://github.com/csm10495/PySimpleGUI-4-foss", # original is no longer opensource :/
        "git+https://github.com/csm10495/psgtray", # not sure i trust pysimplegui to not drop opensource :/
        "pywin32",
        "tendo",
        "pyautogui",
        "appdirs",
